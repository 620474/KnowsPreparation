...
const DEFAULT_REQUIREMENTS: Record<string, RequirementSeed[]> = {
  ...
  yandex: [
    ...
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 0.8, required: false },
    { skillId: "react", capabilities: ["explain", "apply", "debug"], importance: 0.7, required: false },
  ],
  ozon: [
    { skillId: "javascript", capabilities: ["explain", "apply", "debug", "code"], importance: 1.4, required: true },
    { skillId: "async", capabilities: ["explain", "apply", "debug", "code"], importance: 1.3, required: true },
    { skillId: "browser", capabilities: ["explain", "apply", "debug"], importance: 1.1, required: true },
    { skillId: "algorithms", capabilities: ["apply", "code", "transfer"], importance: 1, required: true },
    { skillId: "typescript", capabilities: ["explain", "apply", "code"], importance: 1, required: true },
    { skillId: "react", capabilities: ["apply", "debug", "transfer"], importance: 0.6, required: false },
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 0.8, required: false },
  ],
  avito: [
    { skillId: "javascript", capabilities: ["explain", "apply", "debug", "code", "defend"], importance: 1.4, required: true },
    { skillId: "algorithms", capabilities: ["apply", "code", "defend", "transfer"], importance: 1.4, required: true },
    { skillId: "react", capabilities: ["apply", "debug", "code", "design"], importance: 1.3, required: true },
    { skillId: "typescript", capabilities: ["apply", "code"], importance: 1.2, required: true },
    { skillId: "browser", capabilities: ["explain", "apply", "debug", "resilience"], importance: 1.1, required: true },
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 1.5, required: true },
    { skillId: "testing", capabilities: ["apply", "defend"], importance: 0.9, required: false },
  ],
  tbank: [
    { skillId: "javascript", capabilities: ["explain", "apply", "debug", "code", "defend"], importance: 1.4, required: true },
    { skillId: "react", capabilities: ["explain", "apply", "debug", "code"], importance: 1.3, required: true },
    { skillId: "typescript", capabilities: ["apply", "code"], importance: 1, required: true },
    { skillId: "algorithms", capabilities: ["apply", "code", "defend", "transfer"], importance: 1.5, required: true },
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 1.5, required: true },
    { skillId: "browser", capabilities: ["explain", "apply", "debug"], importance: 1, required: true },
    { skillId: "testing", capabilities: ["apply", "debug", "design"], importance: 0.8, required: false },
  ],
  mts: [
    { skillId: "javascript", capabilities: ["explain", "apply", "debug"], importance: 1.1, required: true },
    { skillId: "react", capabilities: ["explain", "apply", "debug", "code", "design"], importance: 1.5, required: true },
    { skillId: "typescript", capabilities: ["explain", "apply", "code"], importance: 1.3, required: true },
    { skillId: "browser", capabilities: ["explain", "apply", "debug"], importance: 1, required: true },
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 1.2, required: true },
    { skillId: "testing", capabilities: ["apply", "debug", "design"], importance: 1, required: false },
    { skillId: "async.realtime", capabilities: ["explain", "apply", "debug", "design", "resilience"], importance: 0.8, required: false },
  ],
  "2gis": [
    { skillId: "javascript", capabilities: ["explain", "apply", "debug", "code"], importance: 1.3, required: true },
    { skillId: "async", capabilities: ["explain", "apply", "debug"], importance: 1.2, required: true },
    { skillId: "react", capabilities: ["explain", "apply", "debug", "code", "design"], importance: 1.4, required: true },
    { skillId: "typescript", capabilities: ["apply", "code"], importance: 1, required: true },
    { skillId: "browser", capabilities: ["explain", "apply", "debug", "resilience"], importance: 1.4, required: true },
    { skillId: "architecture", capabilities: ["design", "defend", "transfer"], importance: 1.1, required: false },
    { skillId: "algorithms", capabilities: ["apply", "code"], importance: 0.7, required: false },
  ],
};

export const getBuiltinTargetRequirements = (targetId: string) =>
  (DEFAULT_REQUIREMENTS[targetId] ?? []).map((requirement) => ({ ...requirement }));
