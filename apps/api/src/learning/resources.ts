...
export const RESOURCE_PLANS: WeekResourcePlan[] = [
  ...
  },
  {
    theory: [
      ...
      ["js-prototype", "js-class", "ydkjs", "yandex-solid"],
      ["js-class", "js-prototype", "patterns-dev"],
    ...
    practice: [
      ...
      ["js-currying"],
      ["js-prototype", "js-class", "patterns-dev"],
      ["yandex-solid", "patterns-dev", "mdn-websocket"],
      ["leetcode-min-window"],
  ...
  },
  {
    theory: [
      ...
      ["developer-custom-hooks", "react-rules-hooks", "mdn-websocket"],
    ],
    practice: [
      ["react-rules-hooks"],
      ...
      ["developer-context"],
      ["tanstack-query", "redux-style", "zustand"],
      ["developer-custom-hooks", "mdn-websocket", "react-devtools", "testing-library"],
    ],
  },
  {
    theory: [
  ...
  },
  {
    theory: [
      ...
      ["mdn-websocket", "mdn-sse", "developer-custom-hooks"],
    ...
    practice: [
      ...
      ["mdn-websocket", "mdn-sse", "react-devtools"],
      ["mdn-service-worker", "tanstack-optimistic"],
    ],
  },
  {
    theory: [
      ...
      ["pragmatic-dry", "fowler-beck-design-rules", "google-tests-dry-damp"],
      ["developer-composition", "patterns-dev", "mdn-websocket"],
      [
        "fsd-overview",
        "fsd-layers",
        "vk-fsd",
      ...
      ["google-code-review-complexity", "avito-components", "react-components-pure"],
      ["yandex-prep", "frontend-handbook", "avito-strong-frontend", "wb-head-frontend-interview"],
    ],
    practice: [
      [
        "js-prototype",
      ...
      ["yandex-solid", "cleancoder-srp", "react-components-pure"],
      ["pragmatic-dry", "fowler-beck-design-rules", "google-tests-dry-damp"],
      ["developer-composition", "mdn-websocket", "patterns-dev"],
      [
        "fsd-layers",
        "vk-fsd",
        "yandex-frontend-architecture",
      ...
      ["google-code-review-complexity", "avito-components"],
      ["yandex-prep", "frontend-handbook", "avito-strong-frontend", "wb-head-frontend-interview"],
    ],
  },
  {
  ...
  },
  {
    ...
    practice: [
      ...
      ["leetcode-plan", "avito-algo-tips", "leetcode-two-sum-ii", "leetcode-longest-substring"],
      ["avito-system-design"],
      ["avito-strong-frontend", "yandex-prep"],
      ["frontend-handbook", "yandex-prep"],
      ["yandex-interview", "frontend-handbook"],
