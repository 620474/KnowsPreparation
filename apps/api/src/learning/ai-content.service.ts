  ...
  async reviewGeneratedLesson(
    ...
    const result = await this.request<unknown>(
      ...
      [
        ...
        "Если ошибки можно безопасно исправить, верни verdict revised и полный исправленный урок в correctedLesson, сохранив строгую структуру, ровно 20 вопросов (Core 10 + Deep 10), публичные и скрытые тесты практики.",
