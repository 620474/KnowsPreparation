...
| **Исследования** | Проекты, evidence matrix, выводы, риски, этапы и quality gates |
...
| Раздел | Назначение |
| --- | --- |
| **Сегодня** | Следующий шаг, повторения, интервью и активное исследование |
| **Подготовка** | Яндекс, Ozon, основной план и симулятор собеседования |
...
└── client/                      React, Mantine и Capacitor Android
    └── src/
        ├── features/            разделы подготовки, знаний и исследований
